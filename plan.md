...
└───────────────┘   └───────────────┘
```
Used for literature / problem / gap.

### Layout C — Pipeline slide
```text
TITLE

A → B → C → D → E
```
Used extensively for implementation sequence.

### Layout D — Architecture slide
```text
TITLE
        ...
        └───────────┘
```
Used for architecture and verification.

### Layout E — Results slide
```text
TITLE

       BIG RESULT       BIG RESULT       BIG RESULT
...
This repetition makes the presentation feel **designed and coherent rather than complicated**.
